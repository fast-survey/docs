...
<Flexbox>
    <img src="/img/docs/concepts/email-verification-01.png" style={{width: "min(100%, 450px)", borderRadius:"6px"}}/>
</Flexbox>
...
<Flexbox>
    <img src="/img/docs/concepts/email-verification-02.png" style={{width: "min(100%, 450px)", borderRadius:"6px"}}/>
</Flexbox>
...
<Flexbox>
    <img src="/img/docs/concepts/email-verification-03.png" style={{width: "min(100%, 450px)", borderRadius:"6px"}}/>
</Flexbox>
